...
public class ClientDetailsLocators {
    ...
    // Локатор для внешнего контейнера выпадающего списка
   // public static final By selectSearchContainer = By.className("select-search");

    // Локатор для контейнера значения выбранной станции метро
   // public static final By selectSearchValueContainer = By.className("select-search__value");
}
