...
public class ScooterOrderPageLocators {
    ...
    public static final By RENTAL_PERIOD_OPTION(String optionText) {
        return By.xpath(String.format("//div[contains(@class, 'Dropdown-menu')]/div[text()='%s']", optionText)); // Опция срока аренды по тексту
    }
