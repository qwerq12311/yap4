...
public class ScooterOrderPage {
    ...
    public boolean isOrderConfirmationDisplayed() {
        return isElementDisplayed(ScooterOrderPageLocators.locatorOrderConfirmed);
    }
    ...
    public String getOrderElementText() {
        return driver.findElement(ScooterOrderPageLocators.locatorOrderNumberLabel).getText();
    }
